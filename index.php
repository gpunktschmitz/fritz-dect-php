...
#switch<?php echo $deviceArray['id'] ?>:checked ~ .switch:after {
  background: #b1ffff;
...
<table>
<?php foreach($outputDevicesArray as $deviceArray) { ?>
<tr><td><span id="devicetitle"><?php echo $deviceArray['name']?></span></td><td><input type="checkbox" id="switch<?php echo $deviceArray['id']?>" name="switch<?php echo $deviceArray['id']?>" ain="<?php echo $deviceArray['identifier'] ?>" <?php echo $deviceArray['switch_state']?>><label for="switch<?php echo $deviceArray['id']?>" class="switch"></label></td></tr>
<?php } ?>
</table>
</div>
<script>
